...
import './BetweenRangeSlider.css';

const LowerRangeSlider = (props) => {
	let baseClassName = 'between-range-slider';
	...
	return (
		<div id={ID} className={baseClassName} onWheel={onMouseWheel}>
			<div className='bar'>
				<div className='bar-left' style={{ width: barMin + '%' }}/>
				...
				<div className='bar-right' style={{ width: barMax + '%' }}/>
			</div>
			{ruler && (
				<div className='ruler'>
...
export default LowerRangeSlider;
