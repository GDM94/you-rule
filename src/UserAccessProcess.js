...
class UserAccessProcess extends React.Component {
    constructor(props) {
    ...
    redirect = (idToken) => {
        ...
        this.props.history.push({pathname: process.env.REACT_APP_SENSORS_URL, state: { token: idToken } })
    }
...
export default withRouter(UserAccessProcess)
